...
class TestStorageVectors(OpenWPMTest):
    ...
    def test_flash_cookies(self):
        ...
        assert lso_count == 2
        lso_content_a = list(tuple(qry_res[0])[2:])  # Remove first two items
        lso_content_b = list(tuple(qry_res[1])[2:])  # Remove first two items
    ...
    def test_js_profile_cookies(self):
        ...
        cookies = tuple(qry_res[0])  # take the first cookie
