...
HIDDEN_FORM_TEST_URL = u'%s/hidden_form.html' % BASE_TEST_URL

hidden_form_insertions = [(HIDDEN_FORM_TEST_URL,
                           HIDDEN_FORM_TEST_URL, u'true',
                           u'BODY/DIV[1,div1,,false,,]/FORM[1,,,false,,]',
                           FORM_HTML,
                           u'form'),
                          (HIDDEN_FORM_TEST_URL,
                           HIDDEN_FORM_TEST_URL, u'false',
...
form_insertion_js_calls = [(FORM_SNIFFER_SCRIPT,
                            u'window.HTMLInputElement.attributes', u'get',
                            u'{}', None, None),
                           (FORM_SNIFFER_SCRIPT,
                            u'window.HTMLInputElement.id', u'set', u'email',
                            None, None),
                           (FORM_SNIFFER_SCRIPT,
                            u'window.HTMLInputElement.type', u'set', u'email',
                            None, None),
                           (FORM_SNIFFER_SCRIPT,
                            u'window.HTMLInputElement.name', u'set', u'email',
                            None, None),
                           (FORM_SNIFFER_SCRIPT,
                            u'window.HTMLInputElement.id', u'set', u'password',
                            None, None),
                           (FORM_SNIFFER_SCRIPT,
                            u'window.HTMLInputElement.type', u'set', u'password',
                            None, None),
                           (FORM_SNIFFER_SCRIPT,
                            u'window.HTMLInputElement.name', u'set', u'password',
                            None, None),
                           (FORM_SNIFFER_SCRIPT,
                            u'window.HTMLInputElement.value', u'get',
                            u'randomtestuser@gmail.com', None, None),
                           (FORM_SNIFFER_SCRIPT,
                            u'window.HTMLInputElement.value', u'get',
