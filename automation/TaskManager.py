...
class TaskManager:
    ...
    def _start_thread(self, browser, command_sequence, condition=None):
        ...
        self.sock.send(("INSERT INTO site_visits "
                        ...
                        "first_party, site_rank) "
                        "VALUES (?,?,?,?,?)",
                        (self.next_visit_id, browser.crawl_id,
                         command_sequence.url, command_sequence.first_party,
                         command_sequence.site_rank)))
